...
input(
    "Calculadora básica - Informe dois numeros inteiros para o sistema realizar as operações básicas! Pressione  o botão 'Enter', para continuar ... "
)
...
input(
    "Média de notas - Informe três notas para calcularmos a média aritmética! Pressione  o botão 'Enter', para continuar ... "
)
...
input(
    "Conversor de temperatura - Conversão de temperatura de Celsius para Fahrenheit! Pressione  o botão 'Enter', para continuar ... "
)
...
print(
    "O Valor de",
    float(temperatura_C),
    "Celsius convertido em Fahrenheit é ",
    valor_Fahrenheit,
)
...
input(
    "Área de um círculo - Calculo da area de um círculo! Pressione  o botão 'Enter', para continuar ... "
)
...
print(f"O valor da area do círculo é {valor_raioCirculo:.2f}" )

input("Pressione  o botão 'Enter', para continuar ... ")

input(
    "Calculadora de IMC - Calculo do IMC! Pressione  o botão 'Enter', para continuar ... "
)
...
input(
    "Desconto em compras - Calculo do valor final de uma compra com um desconto de 10%! Pressione  o botão 'Enter', para continuar ... "
)
...
input(
    "Tempo de viagem - Calculo de tempo de viagem! Pressione  o botão 'Enter', para continuar ... "
)
...
input(
    "Juros simples- Calculo do montante final de um investimento com juros simples! Pressione  o botão 'Enter', para continuar ... "
)
...
input(
    "Fórmula de Bhaskara- Calculo de resolva uma equação do segundo grau usando a formula de Bhaskara! Pressione  o botão 'Enter', para continuar ... "
)
...
input(
    "Conversor de moedas- Calculo de conversão reais para dólares! Pressione  o botão 'Enter', para continuar ... "
)
